...
const projectKnowledge = [
  {
    content:
      'Retail Cash Flow Dashboard: An automated system that tracks daily cash flows for retail stores. Integrates Google Sheets with Power BI for real-time financial insights. Reduced manual errors by 80% and saved over 5 hours weekly on financial reporting.',
    metadata: { project: 'retail-cash-flow', type: 'overview' },
  },
  {
    content:
      'Ekam Attendance System: Uses facial recognition to track employee attendance. Features real-time monitoring, automated reporting, and integrates with existing HR systems.',
...
const initVectorStore = async () => {
  ...
  try {
    console.warn(
      'Pinecone is not supported in browser environment. Using static knowledge base instead.'
    );
    return;
  } catch (error) {
...
function getRelevantContext(query) {
  ...
  const relevantProjects = Object.entries(knowledgeBase).filter(
    ([key, project]) =>
...
const projectDetails = {
  'zomato analysis': {
    path: '/projects/zomato-analysis',
    description:
      'Zomato Analysis: A data analysis project that provides insights into restaurant trends, ratings, and customer preferences using Zomato data. Features include data visualization, trend analysis, and restaurant recommendations.',
  },
  'bansal supermarket': {
    path: '/projects/bansal-supermarket',
    description:
      'Bansal Supermarket Dashboard: A comprehensive retail management system with inventory tracking, sales analytics, and customer management features. Built with React, Node.js, and MongoDB.',
  },
  'ekam attendance': {
    path: '/projects/ekam-attendance',
    description:
      'Ekam Attendance System: A facial recognition-based attendance system that automates employee check-ins. Features real-time face detection, automated reporting, and HR system integration.',
  },
  'retail cash flow': {
    path: '/projects/retail-cash-flow',
    description:
      'Retail Cash Flow Management: A solution for tracking and managing cash flow in retail environments. Includes features for sales tracking, expense management, and financial reporting.',
  },
  'product sales dashboard': {
    path: '/projects/product-sales-dashboard',
    description:
      'Product Sales Dashboard: An interactive dashboard for visualizing and analyzing product sales data. Built with modern web technologies for real-time data visualization.',
  },
  'snape sentiment analysis': {
    path: '/projects/snape-sentiment-analysis',
    description:
      'Snape Sentiment Analysis: A natural language processing project that analyzes sentiment in text data. Uses machine learning to determine the emotional tone of written content.',
  },
...
const navigationIntents = {
  ...Object.fromEntries(Object.entries(projectDetails).map(([key, { path }]) => [key, path])),
};
...
const commonQuestions = {
  ...
  // Projects
  projects:
    "Here are some of Sahil's notable projects:\n\n" +
  ...
  retail:
    'Retail Cash Flow Management System:\n' +
  ...
  // Skills
  skills:
    'Sahil has expertise in the following areas:\n\n' +
  ...
  // Experience
  experience:
    'Sahil has professional experience in:\n\n' +
...
const generateAIResponse = async (messages) => {
  try {
    ...
    const systemMessage =
      new SystemMessage(`You are a helpful AI assistant for Sahil's portfolio. Use the following context to answer questions:
      ${context}
