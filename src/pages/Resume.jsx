    ...
    <main>
      ...
      <section aria-labelledby="experience-title">
        ...
        <article>
          ...
          <p><strong>Ekam Indian Groceries, Adelaide, Australia</strong><br />
          Dec 2023 – June 2025</p>
          <ul>
          ...
          <p><strong>Highlights:</strong> Reduced billing errors and improved invoice match accuracy by 95%. Saved over 4 hours per week through structured Excel logs and automation.</p>
        </article>

        <article>
          <h3>GRN Officer</h3>
          <p><strong>Bansal Supermarket, Surat, India</strong><br />
          Dec 2022 – Nov 2023</p>
          <ul>
          ...
          <p><strong>Highlights:</strong> Reduced stock discrepancies by 30% through enhanced GRN practices. Improved offer accuracy and register organization across 500+ SKUs.</p>
        </article>

        <article>
          <h3>Warehouse Supervisor</h3>
          <p><strong>Arzt Health & Private Limited – Jaipur, India</strong><br />
          June 2022 – Nov 2022</p>
          <ul>
          ...
          <p><strong>Highlights:</strong> Achieved 100% stock availability across training cycles. Streamlined warehouse layout and improved stock handling speed.</p>
        </article>
      </section>

      <section aria-labelledby="education-title">
        <h2 id="education-title">Education</h2>
        <p><strong>Bachelor of Science (B.Sc.) – Computer Science</strong><br />
        MDSU University, Rajasthan (2018 – 2021)</p>
      </section>
    </main>
  );
};
