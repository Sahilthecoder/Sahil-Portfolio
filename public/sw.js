...
const CACHE_NAME = 'portfolio-cache-v18'; // Updated version to force cache refresh
...
const ASSETS_TO_CACHE = [
  ...
  '/Sahil-Portfolio/favicons/android-chrome-192x192.png',
  '/Sahil-Portfolio/favicons/android-chrome-512x512.png',
  '/Sahil-Portfolio/favicons/favicon.svg',
  '/Sahil-Portfolio/favicons/apple-touch-icon.png',
  '/Sahil-Portfolio/favicons/mstile-150x150.png',
  '/Sahil-Portfolio/favicons/mstile-310x310.png',
