...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-900 focus:ring-gray-500 border-transparent dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white',
  danger: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-500 border-transparent',
  ghost: 'bg-transparent hover:bg-gray-100 text-gray-700 hover:text-gray-900 focus:ring-gray-500 border-transparent dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white',
  outline: 'bg-transparent hover:bg-gray-50 text-gray-700 border-gray-300 hover:text-gray-900 focus:ring-blue-500 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white',
...
export const Button = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:pointer-events-none';
